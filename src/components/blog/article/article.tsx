...
export default function ArticleComponent({ slug }: ArticleComponentProps) {
  ...
  const encodedMessage = encodeURIComponent(tgmessage);
      ...
      <article className={styles.article}>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.cta}>
            ...
            <button className={styles.ctaButton} ><a href={`https://t.me/+79029830005?text=${encodedMessage}`}>Записаться онлайн</a></button>
          </div>
        </div>
